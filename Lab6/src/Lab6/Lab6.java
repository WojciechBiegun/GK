...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    private void piramid(float n, GL2 gl2,float [] color) {
        ...
        for (int i = 0; i < n; i++) {
        	...
        	//else
        		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, color, 0);
	...
	public void display(GLAutoDrawable drawable) {    
		...
		float[] zero = { 0, 0, 0, 1 };
		float[] brass = {0.329412f, 0.223529f, 0.027451f, 1.0f, 0.780392f, 0.568627f, 0.113725f, 1.0f, 0.992157f, 0.941176f, 0.807843f, 1.0f, 0.21794872f*128};
	...
	//	gl2.glEnable(GL2.GL_LIGHT7);
		//gl2.glEnable(GL2.GL_LIGHT_MODEL_TWO_SIDE);
		float[] green = { 0, 0.6f, 0, 1 };
		//gl2.glLightfv(GL2.GL_LIGHT_MODEL_TWO_SIDE, GL2.GL_AMBIENT_AND_DIFFUSE, green,0);
